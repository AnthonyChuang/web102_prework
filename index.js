...
// Call the function to connect event handlers with buttons
connectButtons();
...
const unfundedGamesExplanation = numberOfUnfundedGames === 1 ?
`1 game remains unfunded.` : `${numberOfUnfundedGames} games remain unfunded.`;

const informationTemplate = `
A total of $${totalRaised.toLocaleString('en-US')}
has been raised for ${GAMES_JSON.length} games.
Currently, ${unfundedGamesExplanation} We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const paragraphElement = document.createElement('p');
paragraphElement.textContent = informationTemplate;
...
const [mostFundedGame, secondMostFundedGame, ...otherGames] = sortedGames;
